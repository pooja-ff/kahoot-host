...
import 'quiz_creator_page_model.dart';
export 'quiz_creator_page_model.dart';

class QuizCreatorPageWidget extends StatefulWidget {
  const QuizCreatorPageWidget({Key? key}) : super(key: key);

  @override
  _QuizCreatorPageWidgetState createState() => _QuizCreatorPageWidgetState();
}

class _QuizCreatorPageWidgetState extends State<QuizCreatorPageWidget> {
  late QuizCreatorPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => QuizCreatorPageModel());
              ...
              children: [
                ...
                Padding(
                  ...
                  child: TextFormField(
                    ...
                    maxLines: null,
                    validator:
                        _model.optionAControllerValidator.asValidator(context),
                  ),
                ),
                Padding(
                  padding:
                  ...
                  child: TextFormField(
                    ...
                    maxLines: null,
                    validator:
                        _model.optionBControllerValidator.asValidator(context),
                  ),
                ),
                Padding(
                  padding:
                  ...
                  child: TextFormField(
                    ...
                    maxLines: null,
                    validator:
                        _model.optionCControllerValidator.asValidator(context),
                  ),
                ),
                Padding(
                  padding:
                  ...
                  children: [
                      ...
                      child: Padding(
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                                  ...
                                  createQuestionStruct(
                                    ...
                                    fieldValues: {
                                      'options': functions.createIntoList(
                                          ...
                                          _model.optionBController.text,
                                          _model.optionCController.text,
                                          _model.optionDController.text),
                                    },
                            ...
                            context.goNamed('QuizCreatorPage');
                    ...
                    Align(
                      ...
                      child: Padding(
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            if ((_model.questionController.text != null &&
                                    _model.questionController.text != '') &&
                                (_model.optionAController.text != null &&
                                    _model.optionAController.text != '')) {
                              final gamesUpdateData = {
                                'questionList': FieldValue.arrayUnion([
                                  getQuestionFirestoreData(
